...
public class HistoricalFileModificationDataHolderToFileModificationDataHolderTransformerServiceImpl implements HistoricalFileModificationDataHolderToFileModificationDataHolderTransformerService {
    private FileModificationSuggestionRecordToFileModificationTransformerService fileModificationSuggestionRecordToFileModificationTransformerService;
    private FileModificationSuggestionModificationRecordToFileModificationSuggestionModificationTransformerService fileModificationSuggestionModificationRecordToFileModificationSuggestionModificationTransformerService;

    @Inject
    public HistoricalFileModificationDataHolderToFileModificationDataHolderTransformerServiceImpl(FileModificationSuggestionRecordToFileModificationTransformerService fileModificationSuggestionRecordToFileModificationTransformerService,
                                                                                                  FileModificationSuggestionModificationRecordToFileModificationSuggestionModificationTransformerService fileModificationSuggestionModificationRecordToFileModificationSuggestionModificationTransformerService) {
