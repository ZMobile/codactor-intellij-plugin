...
public class AiFileModificationSuggestionDiffViewerServiceImpl implements AiFileModificationSuggestionDiffViewerService {
    private Project project;

    @Inject
    public AiFileModificationSuggestionDiffViewerServiceImpl(Project project) {
