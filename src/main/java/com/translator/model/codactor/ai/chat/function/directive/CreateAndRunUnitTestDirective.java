...
public class CreateAndRunUnitTestDirective extends Directive {
    ...
    public CreateAndRunUnitTestDirective() {
        ...
        GptFunction endTestAndReport = new GptFunction("end_test_and_report", "Clean up/delete the unit test and end the test loop. Not to be done before running the test, also please request confirmation before doing so.", terminateTestLoopParams);
