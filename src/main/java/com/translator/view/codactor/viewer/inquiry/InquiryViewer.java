...
public class InquiryViewer extends JPanel {
    ...
    private void initComponents() {
        ...
        //inquiryChatList.setMaximumSize(new Dimension(getWidth(), Integer.MAX_VALUE));
        ...
        jBScrollPane1 = new JBScrollPane(inquiryChatList);
        ...
        autoGenerate.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if (selectedChat > 0){
                    ...
                    MultiFileCreateDialog multiFileCreateDialog = new MultiFileCreateDialog(null, inquiryChat.getMessage(), openAiModelService, codactorToolWindowService, massCodeFileGeneratorService, promptContextService, promptContextBuilderDialogFactory);
        ...
        layout.setVerticalGroup(
                layout.createSequentialGroup()
                        .addComponent(jToolBar2, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
                        .addComponent(jBScrollPane1, GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE, Short.MAX_VALUE) // Set size for inquiryChatList
                        .addGap(5)
                        .addComponent(jToolBar3, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
                        .addGap(5)
                        // Add a gap of 20 between inquiryChatList and JBTextArea
    ...
    public void updateInquiryContents(Inquiry inquiry, InquiryChat previousInquiryChat) {
        ...
        inquiryChatList.setPreferredSize(new Dimension(jBScrollPane1.getWidth() - 20, totalHeight));
        inquiryChatList.getParent().addComponentListener(componentListener);
        inquiryChatList.setModel(model);
        jBScrollPane1.setViewportView(inquiryChatList);
    }
    ...
    public void componentResized(DefaultListModel<InquiryChatViewer> previousModel) {
        SwingUtilities.invokeLater(() -> {
            ...
            inquiryChatList.setPreferredSize(new Dimension(jBScrollPane1.getWidth() - 20, newTotalHeight));
