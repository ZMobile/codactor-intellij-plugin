 ...
 * @version $Id$
 */
public class CodactorUmlDefaultDrawingView
        extends JComponent
    ...
    private class EventHandler implements FigureListener, CompositeFigureListener, HandleListener, FocusListener {
        ...
        public void handleRequestSecondaryHandles(HandleEvent e) {
            ...
            for (Handle h : secondaryHandles) {
                h.setView(CodactorUmlDefaultDrawingView.this);
        ...
        public void focusGained(FocusEvent e) {
            //   repaintHandles();
            if (editor != null) {
                editor.setActiveView(CodactorUmlDefaultDrawingView.this);
            }
        }
    ...
    private CodactorUmlDefaultDrawingView.EventHandler eventHandler;
    ...
    private CodactorUmlDefaultDrawingView.EventHandler createEventHandler() {
        return new CodactorUmlDefaultDrawingView.EventHandler();
    }
